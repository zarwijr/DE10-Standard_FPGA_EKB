...
module soc_system_mm_interconnect_2 (
	...
	wire    [6:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> ILC_avalon_slave_agent:cp_channel
	...
	wire  [106:0] alt_vip_vfr_vga_avalon_slave_agent_rf_source_data;                          // alt_vip_vfr_vga_avalon_slave_agent:rf_source_data -> alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [106:0] alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo_out_data;                       // alt_vip_vfr_vga_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_vga_avalon_slave_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> alt_vip_vfr_vga_avalon_slave_agent:cp_valid
	wire  [105:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> alt_vip_vfr_vga_avalon_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                      // alt_vip_vfr_vga_avalon_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> alt_vip_vfr_vga_avalon_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                              // cmd_mux_002:src_startofpacket -> alt_vip_vfr_vga_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                // cmd_mux_002:src_endofpacket -> alt_vip_vfr_vga_avalon_slave_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [105:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> button_pio_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> led_pio_s1_agent:cp_data
	...
	wire          alt_vip_vfr_vga_avalon_slave_agent_rp_valid;                                // alt_vip_vfr_vga_avalon_slave_agent:rp_valid -> router_004:sink_valid
	wire  [105:0] alt_vip_vfr_vga_avalon_slave_agent_rp_data;                                 // alt_vip_vfr_vga_avalon_slave_agent:rp_data -> router_004:sink_data
	wire          alt_vip_vfr_vga_avalon_slave_agent_rp_ready;                                // router_004:sink_ready -> alt_vip_vfr_vga_avalon_slave_agent:rp_ready
	wire          alt_vip_vfr_vga_avalon_slave_agent_rp_startofpacket;                        // alt_vip_vfr_vga_avalon_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          alt_vip_vfr_vga_avalon_slave_agent_rp_endofpacket;                          // alt_vip_vfr_vga_avalon_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [105:0] sysid_qsys_control_slave_agent_rp_data;                                     // sysid_qsys_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [105:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire          led_pio_s1_agent_rp_valid;                                                  // led_pio_s1_agent:rp_valid -> router_008:sink_valid
	wire  [105:0] led_pio_s1_agent_rp_data;                                                   // led_pio_s1_agent:rp_data -> router_008:sink_data
	wire          led_pio_s1_agent_rp_ready;                                                  // router_008:sink_ready -> led_pio_s1_agent:rp_ready
	wire          led_pio_s1_agent_rp_startofpacket;                                          // led_pio_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          led_pio_s1_agent_rp_endofpacket;                                            // led_pio_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire    [6:0] router_src_channel;                                                         // router:src_channel -> mm_bridge_0_m0_limiter:cmd_sink_channel
	...
	wire    [6:0] mm_bridge_0_m0_limiter_cmd_src_channel;                                     // mm_bridge_0_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [6:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> mm_bridge_0_m0_limiter:rsp_sink_channel
	...
	wire    [6:0] router_001_src_channel;                                                     // router_001:src_channel -> fpga_only_master_master_limiter:cmd_sink_channel
	...
	wire    [6:0] fpga_only_master_master_limiter_cmd_src_channel;                            // fpga_only_master_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [6:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> fpga_only_master_master_limiter:rsp_sink_channel
	...
	wire  [105:0] cmd_demux_src2_data;                                                        // cmd_demux:src2_data -> crosser:in_data
	wire          cmd_demux_src2_ready;                                                       // crosser:in_ready -> cmd_demux:src2_ready
	wire    [6:0] cmd_demux_src2_channel;                                                     // cmd_demux:src2_channel -> crosser:in_channel
	...
	wire    [6:0] crosser_out_channel;                                                        // crosser:out_channel -> cmd_mux_002:sink0_channel
	...
	wire  [105:0] cmd_demux_001_src2_data;                                                    // cmd_demux_001:src2_data -> crosser_001:in_data
	wire          cmd_demux_001_src2_ready;                                                   // crosser_001:in_ready -> cmd_demux_001:src2_ready
	wire    [6:0] cmd_demux_001_src2_channel;                                                 // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire  [105:0] crosser_001_out_data;                                                       // crosser_001:out_data -> cmd_mux_002:sink1_data
	wire          crosser_001_out_ready;                                                      // cmd_mux_002:sink1_ready -> crosser_001:out_ready
	wire    [6:0] crosser_001_out_channel;                                                    // crosser_001:out_channel -> cmd_mux_002:sink1_channel
	...
	wire    [6:0] rsp_demux_002_src0_channel;                                                 // rsp_demux_002:src0_channel -> crosser_002:in_channel
	...
	wire  [105:0] crosser_002_out_data;                                                       // crosser_002:out_data -> rsp_mux:sink2_data
	wire          crosser_002_out_ready;                                                      // rsp_mux:sink2_ready -> crosser_002:out_ready
	wire    [6:0] crosser_002_out_channel;                                                    // crosser_002:out_channel -> rsp_mux:sink2_channel
	...
	wire  [105:0] rsp_demux_002_src1_data;                                                    // rsp_demux_002:src1_data -> crosser_003:in_data
	wire          rsp_demux_002_src1_ready;                                                   // crosser_003:in_ready -> rsp_demux_002:src1_ready
	wire    [6:0] rsp_demux_002_src1_channel;                                                 // rsp_demux_002:src1_channel -> crosser_003:in_channel
	...
	wire  [105:0] crosser_003_out_data;                                                       // crosser_003:out_data -> rsp_mux_001:sink2_data
	wire          crosser_003_out_ready;                                                      // rsp_mux_001:sink2_ready -> crosser_003:out_ready
	wire    [6:0] crosser_003_out_channel;                                                    // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	wire    [6:0] mm_bridge_0_m0_limiter_cmd_valid_data;                                      // mm_bridge_0_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [6:0] fpga_only_master_master_limiter_cmd_valid_data;                             // fpga_only_master_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_valid;                    // alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_data;                     // alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo_out_ready;                    // avalon_st_adapter_002:in_0_ready -> alt_vip_vfr_vga_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                          // avalon_st_adapter_002:out_0_valid -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                           // avalon_st_adapter_002:out_0_data -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                          // alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                          // avalon_st_adapter_002:out_0_error -> alt_vip_vfr_vga_avalon_slave_agent:rdata_fifo_sink_error
	...
	wire          dipsw_pio_s1_agent_rdata_fifo_src_valid;                                    // dipsw_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] dipsw_pio_s1_agent_rdata_fifo_src_data;                                     // dipsw_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          dipsw_pio_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_005:in_0_ready -> dipsw_pio_s1_agent:rdata_fifo_src_ready
	...
	wire          led_pio_s1_agent_rdata_fifo_src_valid;                                      // led_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] led_pio_s1_agent_rdata_fifo_src_data;                                       // led_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          led_pio_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> led_pio_s1_agent:rdata_fifo_src_ready
	...
	soc_system_mm_interconnect_2_router_002 router_006 (
	...
	soc_system_mm_interconnect_2_router_002 router_007 (
	...
	soc_system_mm_interconnect_2_router_002 router_008 (
	...
	soc_system_mm_interconnect_2_rsp_demux_002 rsp_demux_002 (
		.clk                (vga_stream_out_clk_clk),                                        //       clk.clk
		.reset              (alt_vip_vfr_vga_clock_reset_reset_reset_bridge_in_reset_reset), // clk_reset.reset
