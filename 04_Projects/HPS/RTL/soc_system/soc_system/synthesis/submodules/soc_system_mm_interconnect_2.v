...
module soc_system_mm_interconnect_2 (
	...
	wire  [106:0] alt_vip_vfr_0_avalon_slave_agent_rf_source_data;                            // alt_vip_vfr_0_avalon_slave_agent:rf_source_data -> alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [106:0] alt_vip_vfr_0_avalon_slave_agent_rsp_fifo_out_data;                         // alt_vip_vfr_0_avalon_slave_agent_rsp_fifo:out_data -> alt_vip_vfr_0_avalon_slave_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> alt_vip_vfr_0_avalon_slave_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> alt_vip_vfr_0_avalon_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                      // alt_vip_vfr_0_avalon_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> alt_vip_vfr_0_avalon_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> alt_vip_vfr_0_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> alt_vip_vfr_0_avalon_slave_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> ILC_avalon_slave_agent:cp_data
	...
	wire  [105:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> led_pio_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                      // led_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> button_pio_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                      // button_pio_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire  [105:0] alt_vip_vfr_0_avalon_slave_agent_rp_data;                                   // alt_vip_vfr_0_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [105:0] ilc_avalon_slave_agent_rp_data;                                             // ILC_avalon_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [105:0] led_pio_s1_agent_rp_data;                                                   // led_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [105:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [105:0] cmd_demux_001_src1_data;                                                    // cmd_demux_001:src1_data -> crosser_001:in_data
	...
	wire  [105:0] crosser_001_out_data;                                                       // crosser_001:out_data -> cmd_mux_001:sink1_data
	...
	wire  [105:0] rsp_demux_001_src0_data;                                                    // rsp_demux_001:src0_data -> crosser_002:in_data
	...
	wire  [105:0] crosser_002_out_data;                                                       // crosser_002:out_data -> rsp_mux:sink1_data
	...
	wire  [105:0] rsp_demux_001_src1_data;                                                    // rsp_demux_001:src1_data -> crosser_003:in_data
	...
	wire  [105:0] crosser_003_out_data;                                                       // crosser_003:out_data -> rsp_mux_001:sink1_data
